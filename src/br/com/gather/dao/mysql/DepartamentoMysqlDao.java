...
public class DepartamentoMysqlDao implements DepartamentoDao {

	private Connection conexao;
	private ResultSet resultado;
	private PreparedStatement stmt;

	public DepartamentoMysqlDao(Connection conexao) throws ClassNotFoundException, SQLException {
	...
	public void cadastrar(Departamento departamento) throws SQLException {
		String sql = "INSERT INTO T_GTR_DEPARTAMENTO(NM_DEPARTAMENTO, DT_CRIACAO)" + " VALUES(?,CURRENT_TIMESTAMP)";
	...
	public void atualizar(Departamento departamento) throws SQLException, EntidadeNaoEncontradaException {
		String sql = "UPDATE T_GTR_DEPARTAMENTO SET " + "NM_DEPARTAMENTO = ?, DT_ATUALIZACAO = CURRENT_TIMESTAMP"
	...
	public void deletar(int codigo) throws SQLException {
		String sql = "UPDATE T_GTR_DEPARTAMENTO SET DT_EXCLUSAO = CURRENT_TIMESTAMP WHERE ID_DEPARTAMENTO = ?";
