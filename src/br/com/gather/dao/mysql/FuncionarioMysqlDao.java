...
public class FuncionarioMysqlDao implements FuncionarioDao {
	...
	private DepartamentoMysqlDao departamentoDao;
	private ResultSet resultado;
	private PreparedStatement stmt;

	public FuncionarioMysqlDao(Connection conexao) throws ClassNotFoundException, SQLException {
		this.conexao = conexao;
		this.departamentoDao = new DepartamentoMysqlDao(conexao);
	}
	...
	public void cadastrar(Funcionario funcionario) throws SQLException {
		String sql = "INSERT INTO T_GTR_FUNCIONARIO(ID_ACESSO,ID_DEPARTAMENTO,NR_CPF_CNPJ,NM_FUNCIONARIO,DS_EMAIL,DS_SENHA,ST_PRIMEIRO_ACESSO,IN_ATIVO,DT_CRIACAO)"
		...
		stmt.setInt(8, funcionario.isAtivo() ? 1 : 0);
	...
	public void atualizar(Funcionario funcionario) throws SQLException, EntidadeNaoEncontradaException {
		String sql = "UPDATE T_GTR_FUNCIONARIO SET "
				...
				+ "ST_PRIMEIRO_ACESSO = ?, DT_ATUALIZACAO = CURRENT_TIMESTAMP "
	...
	public void deletar(int id) throws SQLException, EntidadeNaoEncontradaException {
		String sql = "UPDATE T_GTR_FUNCIONARIO SET DT_EXCLUSAO = CURRENT_TIMESTAMP WHERE ID_FUNCIONARIO = ?";
