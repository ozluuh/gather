...
public class ReuniaoOracleDao implements ReuniaoDao {
	...
	public ReuniaoOracleDao(Connection conexao) throws ClassNotFoundException, SQLException {
	...
	private Reuniao parse(ResultSet rs) throws SQLException {
		...
		if (codigoGestor != 0) {
			gestor = funcionarioOracleDao.pesquisar(codigoGestor);
		}
	...
	public void cadastrar(Reuniao reuniao) throws SQLException {
		String sql = "INSERT INTO T_GTR_REUNIAO(ID_REUNIAO,ID_GESTOR,DS_REUNIAO,IN_STATUS,DT_CRIACAO)"
				+ " VALUES(SQ_GTR_REUNIAO.NEXTVAL,?,?,?,SYSDATE)";
	...
	public void atualizar(Reuniao reuniao) throws SQLException {
		String sql = "UPDATE T_GTR_REUNIAO SET "
				+ "ID_GESTOR = ?, DS_REUNIAO = ?, IN_STATUS = ?, DT_ATUALIZACAO = SYSDATE" + " WHERE ID_REUNIAO = ?";
	...
	public void deletar(int id) throws SQLException {
		String sql = "UPDATE T_GTR_REUNIAO SET DT_EXCLUSAO = SYSDATE WHERE ID_REUNIAO = ?";
